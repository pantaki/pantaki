                    ...
                    <div className="task-accordion">
                      ...
                      >
                        <AccordionSummary
                          ...
                          id="panel1d-header"
                        >
                              <Typography>Full Task</Typography>
                      ...
                      {task_item.map((task_card, i) => {
                        return (
                          <Accordion
                            expanded={this.state.expanded === task_card.id}
                            onChange={handleChange(task_card.id)}
                          >
                            <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                              <Typography>{task_card.name}</Typography>
                            </AccordionSummary>
                            
                            <AccordionDetails>
                              <Typography>
                                <div value={task_card.id}>
                                  <div className="item-card-header">
                                    <span className="item-card-title">
                                      {task_card.name}
                                    </span>
